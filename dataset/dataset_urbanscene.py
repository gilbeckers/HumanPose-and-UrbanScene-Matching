...
for i in range(start_counter, end_counter+1):
    ...
    for j in range(start_counter, end_counter+1):
        ...
        (result_pose_matching, result_whole) = matching.match_whole(model_pose_features, input_pose_features,
                                                                    detector, matcher,
        ...
        if plot and result_pose_matching:
            plt.show()
