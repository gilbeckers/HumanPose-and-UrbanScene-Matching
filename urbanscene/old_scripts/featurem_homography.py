...
from old_scripts import affine_transformation_old
...
(input_transformed, transformation_matrix) = affine_transformation_old.find_transformation(output_features, input_features)
